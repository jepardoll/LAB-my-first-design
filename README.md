...
Este repositorio contiene la documentación técnica y el diseño de un **Sistema Lógico de Respaldo Eléctrico** para una vivienda. El sistema gestiona de manera automática la prioridad de alimentación entre la red eléctrica convencional y un banco de baterías, incorporando medidas de seguridad mediante un botón de paro de emergencia.
...
![Diagrama de Caja Negra](DiagramaCajaNegra.jpg)
